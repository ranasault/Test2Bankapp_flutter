...
void main() {
  runApp(BankingApp());
}  // This coding is done by Mandeep Singh, i used online sources like chatgpt and update all the coding of main.dart file
      ...
      body: Center(
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 20),
            Text('Welcome to RAJPUTANA BANK', style: TextStyle(fontSize: 20)),
            SizedBox(height: 10),
